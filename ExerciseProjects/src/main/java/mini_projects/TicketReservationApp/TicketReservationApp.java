package mini_projects.TicketReservationApp;
...
public class TicketReservationApp {
    ...
    private static void start() {
        ...
        int select;//DEVAM icin bir sayi ÇIKIŞ için 0 ı seçiniz.
        ...
        do {
            ...
            scanner.nextLine();  // nextInt() methodu \n karakterini okumuyor o yuzden nextLine() i cagirdik
